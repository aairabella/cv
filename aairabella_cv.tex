...
\cvitem{2017--presente}{Profesor Adjunto, Dedicaci\'on Simple, Car\'acter Interino. Facultad de Ciencias F\'isico Matem\'aticas y Naturales. Universidad Nacional de San Luis. Fecha: 01 de Septiembre de 2017 al presente. Responsable de materias: Arquitectura de Computadoras (Ing. Electr\'onica con Orientaci\'on en Sistemas Digitales), Audio y Video (Tecnicatura en Telecomunicaciones) y Producci\'on Multimedial (Tecnicatura en Telecomunicaciones).}
